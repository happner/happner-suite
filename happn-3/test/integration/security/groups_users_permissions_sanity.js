  ...
  context('manage users and groups and permissions', async () => {
    ...
    context('checkpoint utility functions', function() {
      ...
      it(' should compare wildcards', function(callback) {
        ...
        test.expect(testServices.utils.wildcardMatch('/test/compare1/*', '/dodge/*')).to.be(false);
        test
          .expect(testServices.utils.wildcardMatch('/test/compare2/*', '/dodge/explicit'))
          .to.be(false);
    ...
    it('should create a sub group', function(callback) {
      testServices.security.users.upsertGroup(
        ...
        function(e, result) {
          ...
          test
            .expect(result.custom_data.customString === subGroup.custom_data.customString)
            .to.be(true);
          test
            .expect(result.custom_data.customNumber === subGroup.custom_data.customNumber)
            .to.be(true);
          callback();
        }
      );
    ...
    it('should create another sub group', function(callback) {
      testServices.security.users.upsertGroup(
        ...
        function(e, result) {
          ...
          test
            .expect(result.custom_data.customString === anotherSubGroup.custom_data.customString)
            .to.be(true);
          test
            .expect(result.custom_data.customNumber === anotherSubGroup.custom_data.customNumber)
            .to.be(true);
          callback();
        }
      );
    ...
    it('should add permissions to a group', function(callback) {
      ...
      testServices.security.users.upsertGroup(testGroup, function(e, result) {
        ...
        test
          .expect(result.permissions['/*' + test_id + '/permission_wildcard/multiple/*'].actions[0])
          .to.be('set');
        test
          .expect(result.permissions['/' + test_id + '/permission_wildcard/multiple'].actions[0])
          .to.be('set');
        ...
        test
          .expect(result.permissions['/*' + test_id + '/permission_wildcard/multiple/*'].actions[1])
          .to.be('get');
        test
          .expect(result.permissions['/' + test_id + '/permission_wildcard/multiple'].actions[1])
          .to.be('on');
