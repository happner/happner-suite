    ...
    it('does a normal subscription, initialEmit and initialCallback - checks the listener state, then unsubscribes and checks the listener state', function (done) {
      ...
      listenerclient
        ...
        .then(function (reference) {
          ...
          expect(
            listenerclient.state.refCount[
              '{"path":"/ALL@/initialEmitTest/path","event_type":"all","count":0}'
            ]
          ).to.be(1);
        ...
        .then(function (reference) {
          ...
          expect(
            listenerclient.state.refCount[
              '{"path":"/ALL@/initialEmitTest/**","event_type":"all","count":0,"initialEmit":true,"depth":5}'
            ]
          ).to.be(1);
          expect(
            listenerclient.state.refCount[
        ...
        .then(function (reference) {
          ...
          expect(
            listenerclient.state.refCount[
              '{"path":"/ALL@/initialEmitTest/**","event_type":"all","count":0,"initialCallback":true,"depth":5}'
            ]
          ).to.be(1);
          expect(
            listenerclient.state.refCount[
          ...
          expect(
            happnInstance.services.subscription.allListeners(listenerclient.session.id).length
          ).to.be(11);
        ...
        .then(function () {
          ...
          expect(
            listenerclient.state.refCount[
              '{"path":"/ALL@/initialEmitTest/**","event_type":"all","count":0}'
            ]
          ).to.be(undefined);
          expect(
            happnInstance.services.subscription.allListeners(listenerclient.session.id).length
        ...
        .then(function () {
          ...
          expect(
            listenerclient.state.refCount[
              '{"path":"/ALL@/initialEmitTest/**","event_type":"all","count":0,"depth":5}'
            ]
          ).to.be(undefined);
          expect(
            happnInstance.services.subscription.allListeners(listenerclient.session.id).length
        ...
        .then(function () {
          ...
          expect(
            listenerclient.state.refCount[
              '{"path":"/ALL@/initialEmitTest/**","event_type":"all","count":0,"initialCallback":true}'
            ]
          ).to.be(undefined);
          expect(
            listenerclient.state.refCount[
              '{"path":"/ALL@/initialEmitTest/**","event_type":"all","count":0,"initialEmit":true}'
            ]
          ).to.be(undefined);
          expect(
            listenerclient.state.refCount[
