...
describe('cache configuration validation tests', function () {
  ...
  it('invalidates cache config with invalid security_group_permissions.max', () => {
    ...
    expect(result.errors[0].instancePath).to.equal(
      '/config/overrides/0/cache_security_group_permissions/max'
    );
  ...
  //   expect(result.valid).to.equal(false);
  //   expect(result.errors[0].instancePath).to.equal(
  //     '/config/overrides/0/cache_security_group_permissions/maxAge'
  //   );
  //   expect(result.errors[0].message).to.equal('must be integer');
  // });
  ...
  //
  //   expect(result.valid).to.equal(false);
  //   expect(result.errors[0].instancePath).to.equal('/config/overrides/1/cache_security_groups/max');
  //   expect(result.errors[0].message).to.equal('must be integer');
  // });
  ...
  //   expect(result.valid).to.equal(false);
  //   expect(result.errors[0].instancePath).to.equal(
  //     '/config/overrides/1/cache_security_groups/maxAge'
  //   );
  //   expect(result.errors[0].message).to.equal('must be integer');
  // });
  ...
  //   expect(result.valid).to.equal(false);
  //   expect(result.errors[0].instancePath).to.equal(
  //     '/config/overrides/2/cache_security_passwords/max'
  //   );
  //   expect(result.errors[0].message).to.equal('must be integer');
  // });
  ...
  //   expect(result.valid).to.equal(false);
  //   expect(result.errors[0].instancePath).to.equal(
  //     '/config/overrides/2/cache_security_passwords/maxAge'
  //   );
  //   expect(result.errors[0].message).to.equal('must be integer');
  // });
  ...
  //   expect(result.valid).to.equal(false);
  //   expect(result.errors[0].instancePath).to.equal(
  //     '/config/overrides/3/cache_security_user_permissions/max'
  //   );
  //   expect(result.errors[0].message).to.equal('must be integer');
  // });
  ...
  //   expect(result.valid).to.equal(false);
  //   expect(result.errors[0].instancePath).to.equal(
  //     '/config/overrides/3/cache_security_user_permissions/maxAge'
  //   );
  //   expect(result.errors[0].message).to.equal('must be integer');
  // });
  ...
  //
  //   expect(result.valid).to.equal(false);
  //   expect(result.errors[0].instancePath).to.equal('/config/overrides/4/cache_security_users/max');
  //   expect(result.errors[0].message).to.equal('must be integer');
  // });
  ...
  //   expect(result.valid).to.equal(false);
  //   expect(result.errors[0].instancePath).to.equal(
  //     '/config/overrides/4/cache_security_users/maxAge'
  //   );
  //   expect(result.errors[0].message).to.equal('must be integer');
  // });
  ...
  //   expect(result.valid).to.equal(false);
  //   expect(result.errors[0].instancePath).to.equal(
  //     '/config/overrides/5/checkpoint_cache_authorization/max'
  //   );
  //   expect(result.errors[0].message).to.equal('must be integer');
  // });
  ...
  //   expect(result.valid).to.equal(false);
  //   expect(result.errors[0].instancePath).to.equal(
  //     '/config/overrides/5/checkpoint_cache_authorization/maxAge'
  //   );
  //   expect(result.errors[0].message).to.equal('must be integer');
  // });
  ...
  //   expect(result.valid).to.equal(false);
  //   expect(result.errors[0].instancePath).to.equal(
  //     '/config/overrides/6/checkpoint_cache_authorization_token/max'
  //   );
  //   expect(result.errors[0].message).to.equal('must be integer');
  // });
  ...
  //   expect(result.valid).to.equal(false);
  //   expect(result.errors[0].instancePath).to.equal(
  //     '/config/overrides/6/checkpoint_cache_authorization_token/maxAge'
  //   );
  //   expect(result.errors[0].message).to.equal('must be integer');
  // });
  ...
  //
  //   expect(result.valid).to.equal(false);
  //   expect(result.errors[0].instancePath).to.equal('/config/statisticsInterval');
  //   expect(result.errors[0].message).to.equal('must be integer');
  // });
});
