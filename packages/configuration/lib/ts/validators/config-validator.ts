...
export class ConfigValidator {
  ...
  validateCacheConfig(config: any): Object {
    return this.#validate(config, cacheSchema);
  }

  validateConnectConfig(config: any): Object {
    return this.#validate(config, connectSchema);
  }

  validateDataConfig(config: any): Object {
    return this.#validate(config, dataSchema);
  }

  validateProtocolConfig(config: any): Object {
  ...
  validatePublisherConfig(config: any): Object {
    return this.#validate(config, publisherSchema);
  }

  validateSecurityConfig(config: any): Object {
    return this.#validate(config, securitySchema);
  }

  validateSubscriptionConfig(config: any): Object {
    return this.#validate(config, subscriptionSchema);
  }

  validateSystemConfig(config: any): Object {
    return this.#validate(config, systemSchema);
  }

  validateTransportConfig(config: any): Object {
    return this.#validate(config, transportSchema);
  }

  validateHealthConfig(config: any): Object {
    return this.#validate(config, healthSchema);
  }

  validateMembershipConfig(config: any): Object {
    return this.#validate(config, membershipSchema);
  }

  validateOrchestratorConfig(config: any): Object {
    return this.#validate(config, orchestratorSchema);
  }

  validateProxyConfig(config: any): Object {
    return this.#validate(config, proxySchema);
  }

  validateReplicatorConfig(config: any): Object {
    return this.#validate(config, replicatorSchema);
  }

  validateHappnConfig(config: any): Object {
  ...
  validateComponentsConfig(config: any): Object {
    return this.#validate(config, componentsSchema);
  }

  validateEndpointsConfig(config: any): Object {
    return this.#validate(config, endpointsSchema);
  }

  validateModulesConfig(config: any): Object {
  ...
  #validate(config: any, schema: string): any {
