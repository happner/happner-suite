...
class ProtocolConfigBuilder extends BaseBuilder {
    ...
    withInboundLayer(layerFunc) {
        let isValid = __classPrivateFieldGet(this, _ProtocolConfigBuilder_fieldTypeValidator, "f").validateFunctionArgs(layerFunc, 2).isValid;
        if (!isValid)
...
//# sourceMappingURL=protocol-config-builder.js.map