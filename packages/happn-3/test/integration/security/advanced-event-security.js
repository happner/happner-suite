describe(
  ...
  function () {
    ...
    context('testing events firing - multiple groups', function () {
      ...
      testGroup1.permissions['/TEST/a7_eventemitter_security_access/' + test_id + '/twogroups/on'] =
        {
          actions: ['on'],
        };
      let testGroup3 = {
      ...
      testGroup3.permissions['/TEST/a7_eventemitter_security_access/' + test_id + '/twogroups/on'] =
        {
          actions: ['on'],
        };
      testGroup3.permissions[
