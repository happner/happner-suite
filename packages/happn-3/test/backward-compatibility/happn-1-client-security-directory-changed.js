describe(require('../__fixtures/utils/test_helper').create().testName(__filename, 3), function () {
  ...
  var getClient = function (credentials, callback) {
    happn_client.create(
      {
        config: credentials,
        secure: true,
  ...
  function createTestClient(callback) {
    ...
    testGroup.permissions[
      '/security_directory_changed/' + test_id + '/testsubscribe/data/remove/*'
    ] = {
    ...
    client.on(
        ...
        client.on(
          ...
          function (e, listenerId) {
            if (!e) {
              ...
              client.set(
                '/security_directory_changed/' + test_id + '/testsubscribe/data/all/1',
                {
                  property1: 'property1',
                  property2: 'property2',
                  property3: 'property3',
      ...
      function (e, listenerId) {
        if (!e) {
          ...
          //then make the change
          client.set(
            '/security_directory_changed/' + test_id + '/testsubscribe/data/remove/1',
            {
              property1: 'property1',
              property2: 'property2',
              property3: 'property3',
  ...
  var doSetOperation = function (client, options, callback) {
    client.set(
      '/security_directory_changed/' + test_id + '/testsubscribe/data/set/1',
      {
        property1: 'property1',
        property2: 'property2',
        property3: 'property3',
  ...
  it('should do a set operations, modify the set permission, wait a sec and see we are unable to perform the set operation', function (done) {
    ...
    createTestClient(function (e, client) {
      ...
      doSetOperation(client, null, function (e) {
        ...
        removePermission(
          '/security_directory_changed/' + test_id + '/testsubscribe/data/set/*',
          true,
          function (e) {
            if (e) return done(e);
  ...
  it('should do an on, check we receive events, modify the on permission, wait a sec and see we are now unable to do the .on anymore', function (done) {
    ...
    createTestClient(function (e, client) {
      ...
      doSetOperationsForOn2(client, null, function (e) {
        ...
        expect(Object.keys(client.events).length).to.be(1);
          ...
          setTimeout(function () {
            client.on(
              ...
              function (e) {
                ...
                expect(e.toString()).to.be('AccessDenied: unauthorized');
                //client never finds out from server, just stops receiving events
                expect(Object.keys(client.events).length).to.be(1);
                done();
              }
            );
