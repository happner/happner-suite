...
module.exports = {
  ...
  create: util.maybePromisify(function (config, done) {
    ...
    if (config.allowNestedPermissions) {
      _.set(
        config,
        'services.protocol.config.allowNestedPermissions',
        config.allowNestedPermissions
      );
      _.set(
        config,
        'services.subscription.config.allowNestedPermissions',
        config.allowNestedPermissions
      );
    }
    ...
    // config validation
    commons.validateConfig(config, 'HAPPN');
