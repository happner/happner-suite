...
PersistedCache.prototype.increment = util.maybePromisify(increment);
PersistedCache.prototype.update = util.maybePromisify(update);
PersistedCache.prototype.remove = util.maybePromisify(remove);
PersistedCache.prototype.clear = util.maybePromisify(clear);
PersistedCache.prototype.all = util.maybePromisify(all);
PersistedCache.prototype.sync = util.maybePromisify(sync);
