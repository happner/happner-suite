            ...
            function (_dereq_, module, exports) {
              ...
              function context(self, method) {
                ...
                var failure = new Error(
                  'Primus#' + method + "'s context should called with a Primus instance"
                );
              ...
              Primus.prototype.uri = function uri(options) {
                ...
                options.port =
                  'port' in options ? +options.port : +url.port || (options.secure ? 443 : 80);
                ...
                //
                server.push(
                  options.secure ? options.protocol.replace(':', 's:') : options.protocol,
                  ''
                );
                  ...
                  try {
                    ...
                    if (Factory.length === 3) {
                      if ('ws+unix:' === options.protocol) {
                        options.pathname =
                          '/' + primus.url.hostname + primus.url.pathname + ':' + primus.pathname;
                      }
