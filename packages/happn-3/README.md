...
PRIMUS OPTIONS
---------------------
*primusOpts in the configuration can be adjusted to control how the websockets connection behaves, see [here](https://github.com/primus/primus#getting-started)*
```javascript
const serviceConfig = {
  services: {
    session: {
