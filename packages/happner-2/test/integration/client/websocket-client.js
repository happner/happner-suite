require('../../__fixtures/utils/test_helper').describe({ timeout: 120e3 }, (test) => {
  ...
  it('does a set on the datalayer component', function (done) {
    testClient.exchange.websocket_client.data.set(
      ...
      function (e, result) {
        ...
        test.expect(result.val).to.be('set');
  ...
  it('does a get on the datalayer component', function (done) {
    testClient.exchange.websocket_client.data.set(
      ...
      function (e, result) {
        ...
        test.expect(result.val).to.be('get');
        ...
        testClient.exchange.websocket_client.data.get(
          ...
          function (e, getresult) {
            ...
            test.expect(getresult.val).to.be('get');
            done();
          }
        );
      }
  ...
  it('contains the mesh name and version', function () {
    test
      .expect(testClient.info.version)
      .to.be(require(__dirname + '/../../../package.json').version);
    test.expect(testClient.info.name).to.be('websocket_client');
  });
  ...
  it('does a delete on the datalayer component', function (done) {
    testClient.exchange.websocket_client.data.set(
      ...
      function (e, result) {
        ...
        test.expect(result.val).to.be('delete');
        ...
        testClient.exchange.websocket_client.data.get(
          ...
          function (e, getresult) {
            ...
            test.expect(getresult.val).to.be('delete');
              ...
              function (e) {
                ...
                testClient.exchange.websocket_client.data.get(
                  ...
                  function (e, getremovedresult) {
                    ...
                    test.expect(getremovedresult).to.be(null);
                    done();
                  }
                );
              }
