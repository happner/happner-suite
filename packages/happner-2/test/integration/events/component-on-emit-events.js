    ...
    client.exchange.component1.causeEmit(
      ...
      function (e) {
        ...
        client.exchange.component1.getEvents(function (e, events) {
          ...
          test.expect(events[0]).to.not.be(null);
  ...
  it('tests an emit using the deferred transactional consistency, checks the on-emit-ok event', function (done) {
    client.exchange.component1.causeEmit(
      ...
      function (e) {
        ...
        client.exchange.component1.getEvents(function (e, events) {
          if (e) return done(e);
          test.expect(events.ok).to.not.be(null);
          test.expect(events.publishOK.successful).to.be(1);
    ...
    client.exchange.component1.causeEmitError(
      ...
      function (e) {
        ...
        client.exchange.component1.getEvents(function (e, events) {
          ...
          test.expect(events.error).to.be('Error: TEST ERROR');

          test.expect(events.publishError).to.be('Error: TEST ERROR');
                    ...
                    client.exchange.component2.getConcurrentEvents(function (e, events) {
                      ...
                      setTimeout(function () {
                        client.exchange.component2.getConcurrentEvents(function (e, events) {
                          ...
                          test.expect(clientEvents.length).to.be(5);
                  ...
                  client.exchange.component1.causeEmitListener(
                    ...
                    function (e) {
                      ...
                      client.exchange.component2.getListenerEvents(function (e, events) {
                        ...
                        setTimeout(function () {
                          test.expect(events.length).to.be(1);
                          test.expect(clientEvents.length).to.be(1);
      ...
      function (e) {
        ...
        setTimeout(function () {
          client.exchange.component2.getListenerEvents(function (e, events) {
            ...
            test.expect(events.length).to.be(3);
            test.expect(clientEvents.length).to.be(3);
