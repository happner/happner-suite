...
const _ = commons._;
const maybePromisify = commons.maybePromisify;
...
ComponentInstance.prototype.originBindingNecessary = function (mesh, origin, override) {
...
ComponentInstance.prototype.initialize = function (name, root, mesh, module, config, callback) {
  ...
  Object.defineProperty(_this, '__authorizeOriginMethod', {
    get: function () {
      return function (methodName, origin, callback, originBindingOverride) {
        if (!_this.originBindingNecessary(mesh._mesh, origin, originBindingOverride))
...
ComponentInstance.prototype.__attachModuleMethods = function () {
...
ComponentInstance.prototype._loadModule = function (module) {
  ...
  this.__attachModuleMethods();

  Object.defineProperty(this, 'operate', {
    value: function (methodName, parameters, callback, origin, version, originBindingOverride) {
      _this.__authorizeOriginMethod(
        methodName,
        origin,
        function (e) {
          if (e) return callback(e);
